...
export const FREE_LIMITS = {
  ...
  alibi: {
    scenarios: 3,          // Number of alibi scenarios available
...
export const PRO_PRICING = {
  ...
  annual: {
    ...
    currency: 'EUR',
    interval: 'year',
    savings: 37, // 37% discount (3.99*12 = 47.88 vs 29.99)
    label: 'Annuel',
