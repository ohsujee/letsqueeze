...
/**
 * Pro Content Counts
 * Source unique de vérité pour le contenu disponible
 * ⚠️ METTRE À JOUR quand on ajoute du contenu
 */
export const PRO_CONTENT = {
  alibi: {
    total: 30,        // Total alibis disponibles
    free: 4,          // Alibis gratuits (Party Mode)
    get proOnly() { return this.total - this.free; }
  },
  quiz: {
    total: 19,        // Total thèmes actifs (hors "coming soon")
    free: 3,          // Thèmes gratuits
    get proOnly() { return this.total - this.free; }
  }
};
 ...
 * Source unique de vérité pour tous les prix affichés dans l'app
 */
export const PRO_PRICING = {
  ...
  annual: {
    ...
    savings: Math.round((4.99 * 12) - 29.99), // ~30€
    savingsPercent: Math.round(((4.99 * 12 - 29.99) / (4.99 * 12)) * 100) // ~50%
  }
};
