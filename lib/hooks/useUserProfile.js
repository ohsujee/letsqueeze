...
import { isFounder as checkFounder, isSuperFounder as checkSuperFounder } from '../admin';
...
export function useUserProfile() {
      ...
      if (currentUser) {
        ...
        try {
          ...
          unsubscribeUserData = onValue(userRef, (snapshot) => {
            ...
            if (data) {
              // Merge avatar into profile for easy access
  ...
  return {
    ...
    isFounder: checkFounder(user),
    isSuperFounder: checkSuperFounder(user),
  };
}
