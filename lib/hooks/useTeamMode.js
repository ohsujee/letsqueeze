...
// Default team names and colors
const TEAM_NAMES = ['Blaze', 'Frost', 'Venom', 'Solar'];
const TEAM_COLORS = ['#FF2D55', '#00D4FF', '#FFD60A', '#BF5AF2'];
 ...
 * @param {string} options.roomPrefix - Préfixe Firebase ('rooms', 'rooms_blindtest', 'rooms_deeztest')
