  ...
  useEffect(() => {
    ...
    const checkAndRejoin = async () => {
      try {
        ...
        console.log('[PlayerCleanup] Player missing after refresh, attempting auto-rejoin...');
        ...
        console.log('[PlayerCleanup] Auto-rejoin successful');
...
export function useActiveGameCheck(playerUid) {
  ...
  useEffect(() => {
    ...
    const checkActiveGame = async () => {
      try {
        const { roomCode, roomPrefix } = JSON.parse(lastGame);
