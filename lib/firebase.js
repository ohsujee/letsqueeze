...
export const signInWithGoogle = async () => {
  try {
    ...
    if (Capacitor.isNativePlatform()) {
      ...
      // Sign in with native Google (skipNativeAuth: true = on gère le sign-in manuellement
      // sur le web layer, sinon le plugin connecte déjà l'user avant qu'on puisse lier le compte anonyme)
