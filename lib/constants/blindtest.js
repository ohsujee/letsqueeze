/**
 * Constantes partagées pour DeezTest (Blind Test Deezer)
...
// Buffer avant le démarrage synchronisé de l'audio (ms)
// Laisse le temps aux joueurs de recevoir l'event Firebase + preloader l'audio
export const AUDIO_SYNC_BUFFER_MS = 800;
