...
const REVENUECAT_API_KEYS = {
  ios: 'appl_YFpxvRQesYucPqgRqwnEINInBlk',
  android: 'goog_GURlHymDBUvrPJwUBKlwarRaJIU'
};
...
export const ENTITLEMENT_ID = 'Gigglz Pro';
  ...
  try {
    ...
    const pkg = offerings.current.availablePackages?.find(
      p => p.product.identifier === packageId ||
           p.product.identifier.startsWith(packageId + ':')
    );
