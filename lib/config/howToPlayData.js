...
import {
  ...
  ChatCircle, FileText, Warning, CirclesThree, Eye
...
export const GAMES_DATA = {
  ...
  codebreaker: {
    id: 'codebreaker',
    title: 'Code Breaker',
    subtitle: 'Craque le code secret !',
    accentColor: '#6366f1',
    ...
    sections: [
      {
        ...
        content: {
          type: 'intro',
          text: 'Chaque jour, un code secret de 4 couleurs est généré. Propose une combinaison et reçois des indices : quelles couleurs sont bien placées, et lesquelles sont dans le code mais mal placées. Trouve le code en un minimum de tentatives !'
        }
      },
      {
        id: 'indices',
        ...
        content: {
          type: 'scoring',
          items: [
            { label: '🔴 Bien placé', value: 'Bonne couleur, bonne position', icon: CheckCircle, color: '#ef4444' },
            { label: '⚪ Mal placé', value: 'Bonne couleur, mauvaise position', icon: CirclesThree, color: '#e5e7eb' },
            { label: 'Rien', value: 'Couleur absente du code', icon: XCircle, color: '#64748b' },
          ],
          note: 'Les indices ne disent PAS quelle couleur correspond à quel indice — c\'est à toi de déduire !'
        }
      },
      {
        id: 'scoring',
        ...
        content: {
          type: 'scoring',
          items: [
            { label: '1 tentative', value: '~5 800 pts', icon: Lightning, color: '#6366f1' },
            { label: '3 tentatives', value: '~4 800 pts', icon: Lightning, color: '#6366f1' },
            { label: '5 tentatives', value: '~3 800 pts', icon: Lightning, color: '#818cf8' },
            { label: '10 tentatives', value: '~1 300 pts', icon: Lightning, color: '#818cf8' },
          ],
          note: 'Score = base selon les tentatives + bonus rapidité. 10 essais max.'
        }
      }
    ]
  },
