...
export const GAME_COLORS = {
  ...
  mime: {
    ...
    rgba: {
      ...
      medium: 'rgba(5, 150, 105, 0.3)',
      dark: 'rgba(5, 150, 105, 0.5)',
    }
  },
  motmystere: {
    primary: '#2a9d74',
    ...
    glow: '#34d399',
    flat: {
      bg: '#1e1e1e', bgDark: '#141414', bgLight: '#2a2a2a',
      accent: '#333333', accentDark: '#1a1a1a',
      text: '#a7f3d0', muted: '#6ee7b7',
    },
    rgba: {
  ...
  semantique: {
    primary: '#e67e22',       // Flat UI Carrot — chaleureux, lisible sur neutre
    secondary: '#d35400',     // darker carrot
    dark: '#a04000',          // deepest carrot (border-bottom 3D)
    glow: '#f39c12',
    flat: {
      bg: '#7a3d10',          // warm dark rust — cohérent avec carrot
      bgDark: '#4d2508',      // warm darker rust
      bgLight: '#9a4d15',     // warm medium rust
      accent: '#b85a1a',      // mid rust
      accentDark: '#7a3d10',
      text: '#fde4bf',        // warm pale
      muted: '#f5c78a',
    },
    rgba: {
      light: 'rgba(230, 126, 34, 0.15)',
      medium: 'rgba(230, 126, 34, 0.3)',
      dark: 'rgba(230, 126, 34, 0.5)',
    }
  },
};
...
export const GAME_COLOR_MAP = {
  ...
  semantique: GAME_COLORS.semantique.primary,
  motmystere: '#2a9d74',
  total: '#3b82f6',
  codebreaker: '#6366f1',
};
...
/**
 * Display labels for each game type (used in end screens, transitions, etc.)
 */
