 ...
 * @param {string} gameType - quiz | alibi | blindtest | deeztest | trouveregle | mime
...
export const GAME_COLOR_MAP = {
  ...
  blindtest: GAME_COLORS.blindtest.primary,
  deeztest: GAME_COLORS.deeztest.primary,
  trouveregle: GAME_COLORS.trouveregle.primary,
