    ...
    <div style={{
      ...
      <div aria-hidden style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse at 50% 0%, rgba(225,29,72,0.09) 0%, transparent 70%)',
        }} />
        <div style={{
          position: 'absolute', bottom: 0, left: '50%', transform: 'translateX(-50%)',
          width: '60%', height: '120px',
          background: 'radial-gradient(ellipse at 50% 100%, rgba(225,29,72,0.05) 0%, transparent 70%)',
        }} />
      </div>
                      ...
                      return (
                        <motion.button
                          ...
                          style={{
                            ...
                            background: active ? 'rgba(225,29,72,0.1)' : 'rgba(238,242,255,0.03)',
                ...
                <div style={{
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      background: mrWhiteEnabled && canEnableMrWhite ? 'rgba(225,29,72,0.3)' : 'rgba(238,242,255,0.08)',
...
/**
 * Exported content component for use in dev simulator
 */
export { ImposteurLobby as ImposteurLobbyContent };
