...
const BlindTestPlayContent = lazy(() => import('@/app/blindtest/game/[code]/play/page').then(m => ({ default: m.BlindTestPlayContent })));
const BlindTestHostContent = lazy(() => import('@/app/blindtest/game/[code]/host/page').then(m => ({ default: m.BlindTestHostContent })));
const BlindTestEndContent = lazy(() => import('@/app/blindtest/game/[code]/end/page').then(m => ({ default: m.BlindTestEndContent })));
