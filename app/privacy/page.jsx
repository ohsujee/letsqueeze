  ...
  return (
    <div className="legal-page">
      ...
      <header className="legal-header">
        ...
        <h1 className="header-title">Confidentialité</h1>
      </header>

      <main className="legal-content">
        <p className="legal-intro">
          Agence UMAIN s'engage à protéger votre vie privée. Cette politique
        ...
        <section className="legal-section">
          ...
          <p>Lorsque vous créez un compte via Google ou Apple :</p>
          <ul>
            <li>Adresse email</li>
        ...
        <section className="legal-section">
          ...
          <ul>
            ...
            <li>Fournir les fonctionnalités de jeu</li>
            <li>Sauvegarder vos scores et progressions</li>
            <li>Gérer les abonnements Pro</li>
        ...
        <section className="legal-section">
          ...
          <p>
            Pour exercer ces droits, contactez-nous à : <a href="mailto:contact@weareumain.com">contact@weareumain.com</a>
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <ul>
            ...
            <li>Tokens stockés dans des cookies httpOnly sécurisés</li>
            <li>Authentification via fournisseurs sécurisés (Google, Apple)</li>
        ...
        <section className="legal-section">
          ...
          <p>
            ...
            (Firebase, Vercel). Ces transferts sont encadrés par les
        ...
        <section className="legal-section">
          <h2>11. Mineurs</h2>
          <p>
            L'application est destinée aux personnes de 13 ans et plus.
            En utilisant l'application, vous confirmez avoir au moins 13 ans.
            Si vous êtes un parent et pensez que votre enfant de moins de 13 ans
            nous a fourni des données personnelles, contactez-nous pour les supprimer.
          </p>
        </section>
